// Shin Godzilla Inferno & Atomic Aura Laser System (Safe-Run Mode)
(function() {
    function initLaser() {
        const canvas = document.getElementById('laserCanvas');
        if (!canvas) {
            console.error("หาไอดี 'laserCanvas' ไม่พบ! โปรดใส่ <canvas id='laserCanvas'></canvas> ในไฟล์ HTML");
            return;
        }
        ...
        function render() {
            ...
            // 1. เพลิงไหม้ลุกโชนสีส้มแดงที่ฐานล่างเมือง
